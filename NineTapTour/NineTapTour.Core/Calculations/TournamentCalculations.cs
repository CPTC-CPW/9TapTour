...
public static class TournamentCalculations
{
    ...
    /// <param name="membersGameEntryCount">The amount of entries the member has for the tournament</param>
    /// <param name="latestGames">The member's last games with money-won history</param>
    ...
    public static int GetAdjustedBonusPins(int memberPlacement, int totalEntries, int compEntries, int currentBonusPins,
                                            int membersGameEntryCount, List<PlayerHistoryViewModel> latestGames)
    {
