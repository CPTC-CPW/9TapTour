...
namespace NineTapTour.Core.ViewModels
{
    public class TopParticipantGameViewModel
    {
        public TopParticipantGameViewModel(int memberNo, string firstName, string lastName, int placing, int scratchTotal,
            ...
            int? top3ScratchScore, int? top3HandiScores, int? game1, int? game2, int? game3, int? game4, int? handicap, int bonus, int gameID, int squad,
            bool threeOutOf4)//todo: change static numbers
        {
        ...
        /// <summary>
        /// Whether the tournament this score belongs to uses the 3-out-of-4
        /// ruleset. Captured at construction so the display strings do not
        /// depend on cross-form static state.
        /// </summary>
        public bool ThreeOutOf4 { get; }
