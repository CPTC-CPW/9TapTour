...
public class TournamentRepository : ITournamentRepository
{
    ...
    public TournamentRepository(IDbContextFactory<NineTapDb> dbFactory)
    {
    ...
    /// </summary>
    public List<Tournament> GetTournamentList(NineTapDb db)
    {
    ...
    /// NOTE: Does NOT call SaveChanges - caller controls when to save for batch operations.
    /// </summary>
    public void AddMemberToTournament(Participant player, NineTapDb db)
    {
        // Use AsNoTracking to avoid tracking entities in the duplicate check query
        bool isMemberInTournament = db.Participants
            .AsNoTracking()
