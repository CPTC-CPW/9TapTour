...
namespace NineTapTour.Database
{
    public class PlayerHistoryDB
    {
        ...
        /// Queries from Games table (single source of truth).
        /// </summary>
        public static int GetTotalGamesPlayedFromHistory(int memberNum, int numberOfEntriesToTake)
        {
            using NineTapDb db = new();
        ...
        /// </summary>
        public static int GetTotalGame1Played(int memberNum)
        {
            using (var db = new NineTapDb())
            {
                return db.Games
        ...
        /// </summary>
        public static int GetTotalGame2Played(int memberNum)
        {
            using (var db = new NineTapDb())
            {
                return db.Games
        ...
        /// </summary>
        public static int GetTotalGame3Played(int memberNum)
        {
            using (var db = new NineTapDb())
            {
                return db.Games
        ...
        /// </summary>
        public static int GetTotalGame4Played(int memberNum)
        {
            using (var db = new NineTapDb())
            {
                return db.Games
        ...
        /// </summary>
        public static int GetGame1TotalFromHistory(int memberNum, int numberOfEntriesToTake)
        {
            using NineTapDb db = new();
        ...
        /// </summary>
        public static int GetGame2TotalFromHistory(int memberNum, int numberOfEntriesToTake)
        {
            using NineTapDb db = new();
        ...
        /// </summary>
        public static int GetGame3TotalFromHistory(int memberNum, int numberOfEntriesToTake)
        {
            using NineTapDb db = new();
        ...
        /// </summary>
        public static int GetGame4TotalFromHistory(int memberNum, int numberOfEntriesToTake)
        {
            using NineTapDb db = new();
        ...
        /// </summary>
        public static int GetScratchTotalFromHistory(int memberNum, int numberOfGamesToTake)
        {
            using NineTapDb db = new();
        ...
        /// </summary>
        public static int GetEntryAvgTotal(int memberNum, int game1, int game2, int game3, int game4, int games)
        {
            using (var db = new NineTapDb())
            {
                int game1sum = GetTotalGame1Played(memberNum);
                int game2sum = GetTotalGame2Played(memberNum);
                int game3sum = GetTotalGame3Played(memberNum);
                int game4sum = GetTotalGame4Played(memberNum);
                int gameTotalSum = GetTotalGamesPlayed(memberNum);
        ...
        /// </summary>
        public static int GetGameAvgFromHistory(int memberNum, int numberOfEntriesToTake)
        {
            using NineTapDb db = new();
        ...
        /// </summary>
        internal static int GetTotalNumberOfEntries(int memberNumber)
        {
            using NineTapDb db = new();
        ...
        /// </summary>
        internal static int GetNumberOfGamesFromHistory(int memberNumber, int numberOfEntries)
        {
            using NineTapDb db = new();
